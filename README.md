...
Full-stack software engineer and founder of **ImaginecoreX (Pvt) Ltd**.

I build scalable software systems with a focus on clean architecture, performance, and long-term maintainability.
My work spans web, backend, cloud, and product engineering.

Currently focused on building real products, sharpening engineering depth, and compounding execution skills.
